...
import hospitalmodel.hospitalService;

@WebFilter("/hospitalmap.jsp")
public class HEncodingFilter implements Filter {
	...
	public void doFilter(ServletRequest req,
		...
		System.out.println("HAHAHAHAHAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
		
		System.out.println(hospitalServicE.select(null));
