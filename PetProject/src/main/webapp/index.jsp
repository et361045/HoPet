	...
	<div class="page1_block">
		<div class="container_12">
			<div class="grid_6">
				...
				sagittis.<br> <a href="#" class="btn">More</a>
			</div>
					...
					<div class="modal-body" style="margin: 25px">
						...
						<p>
							<label for="account"> 帳號:</label> <br> <input type="text"
								id="account" name="email" required autocomplete="off" style="width: 50%">
						</p>
						   <td><span class="error">${errors.usernamrError}</span></td>
						<p>
							<label for="pew"> 密碼:</label> <br> <input type="password"
								id="pew" name="password" required autocomplete="off" style="width: 50%">
						</p>
						<td><span class="error">${errors.passwordError}</span></td>
					</div>
